    ...
    return (
        <div className="min-h-screen flex bg-white dark:bg-dark-bg transition-colors duration-300">
            ...
            <div className="hidden lg:flex w-1/2 bg-slate-50 dark:bg-slate-900 relative overflow-hidden items-center justify-center">
                ...
                {/* Abstract Blobs */}
                <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-brand-400/30 rounded-full mix-blend-multiply dark:mix-blend-overlay filter blur-3xl opacity-70 animate-blob"></div>
                <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-400/30 rounded-full mix-blend-multiply dark:mix-blend-overlay filter blur-3xl opacity-70 animate-blob animation-delay-2000"></div>
                ...
                <div className="relative z-10 text-center px-12">
                    ...
                    <p className="text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
                        "Security is not a product, but a process. Keep learning, keep securing."
                    </p>
                </div>
            </div>
                        ...
                        <div>
                            ...
                            >
                                <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                                    <Lock className="h-5 w-5 text-brand-500 group-hover:text-brand-400 transition-colors" aria-hidden="true" />
                                </span>
                                Sign in
